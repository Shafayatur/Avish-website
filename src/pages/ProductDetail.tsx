                ...
                <div className="flex gap-3 overflow-x-auto pb-2">
                  {images.map((img: string, i: number) => (
                    <button
                      ...
                      className={`w-20 h-20 rounded-xl bg-cream flex-shrink-0 overflow-hidden border-2 transition-all duration-300 ${!showVideo && selectedImage === i ? "border-primary ring-2 ring-primary/20" : "border-transparent hover:border-primary/40"
                        }`}
                    >
                  ...
                  {videoUrl && (
                    <button
                      ...
                      className={`w-20 h-20 rounded-xl bg-cream flex-shrink-0 overflow-hidden border-2 transition-all duration-300 flex items-center justify-center relative ${showVideo ? "border-primary ring-2 ring-primary/20" : "border-transparent hover:border-primary/40"
                        }`}
                    >
                      {getYouTubeId(videoUrl) ? (
                        <img
